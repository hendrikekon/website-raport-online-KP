...
<tr>
    ...
    $viewguruwalikls=mysql_query("select id_wali_kls, nama_guru, nama_kelas, id_th_ajaran from wali_kelas, guru, kelas where wali_kelas.id_guru=guru.id_guru and wali_kelas.id_kelas=kelas.id_kelas");
    
    $i = 1;
    while($row=mysql_fetch_array($viewguruwalikls)){
        ?>
      <tr>
