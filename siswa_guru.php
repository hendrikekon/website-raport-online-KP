...
<tr>
    ...
    $view=mysql_query("select id_pengajar, nama_guru, nama_pelajaran, nama_kelas, id_th_ajaran from pengajar, guru, mata_pelajaran, kelas where pengajar.id_guru=guru.id_guru and pengajar.kd_mapel=mata_pelajaran.kd_mapel and pengajar.id_kelas=kelas.id_kelas");
    $i = 1;
