...
<tr>
    ...
    $viewguruklssiswa=mysql_query("select id_kls_siswa, nama, nama_kelas, id_th_ajaran from kelas_siswa, Siswa, kelas where kelas_siswa.id_siswa=siswa.id_siswa and kelas_siswa.id_kelas=kelas.id_kelas");
    
    $i = 1;
    while($row=mysql_fetch_array($viewguruklssiswa)){
        ?>
      <tr>
        <td><?php echo $row['id_kls_siswa'];?></td>
