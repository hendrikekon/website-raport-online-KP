...
if(isset($_POST['submit'])){
	...
	for ($i=1; $i<=$jumSis; $i++)
	{
	   ...
	   $query = "update nilai_uts_uas set n_uts='$n_uts', n_uas='$n_uas' where id_siswa='$id_siswa' and kd_mapel='$kd_mapel' and id_kelas='$id_kelas' and id_guru='$id_guru'";
	...
	if($hasil){
		...
		?><script language="javascript">document.location.href="?page=guru_input_nilai_utsuas_selesai&status=0";</script><?php
	}
...
<tr>
    ...
    <div id="content-table-inner">
      ...
      <br />
        ...
        <form id="mainform" action="home.php?page=guru_update_nilai_utsuas" method="post">
		...
		while($row=mysql_fetch_array($view)){
			...
			<tr>
				...
				<td><?php echo "<input type='text' name='n_uts".$i."' size='10' value='".$row['n_uts']."'/>"; ?></td>
				<td><?php echo "<input type='text' name='n_uas".$i."' size='10' value='".$row['n_uas']."'/>"; ?></td>
			</tr>
			<?php
			$i++;
		}
