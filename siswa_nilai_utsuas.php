...
<tr>
    ...
    $view=mysql_query("select * from nilai_uts_uas, mata_pelajaran, kelas where id_siswa='$id_siswa' and nilai_uts_uas.kd_mapel=mata_pelajaran.kd_mapel and nilai_uts_uas.id_kelas=kelas.id_kelas");
