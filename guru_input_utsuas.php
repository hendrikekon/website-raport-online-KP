...
if(isset($_GET['id_guru'])){
	...
	$query=mysql_query("select * from nilai_uts_uas where id_guru='$id_guru' and kd_mapel='$kd_mapel' and id_kelas='$id_kelas'");
	$cek=mysql_num_rows($query);
	
	if($cek=='0'){
		//kalo belum ada mode input
		?><script language="javascript">document.location.href="?page=guru_input_nilai_utsuas&id_guru=<?php echo $id_guru;?>&kd_mapel=<?php echo $kd_mapel;?>&id_kelas=<?php echo $id_kelas;?>";</script><?php
	}else{
		//kalo sudah ada mode update
		?><script language="javascript">document.location.href="?page=guru_update_nilai_utsuas&id_guru=<?php echo $id_guru;?>&kd_mapel=<?php echo $kd_mapel;?>&id_kelas=<?php echo $id_kelas;?>";</script><?php
	}
...
<tr>
    ...
    <div id="content-table-inner">
		...
		<tr>
            ...
            <td><a href="?page=guru_input_utsuas&id_guru=<?php echo $id_guru;?>&kd_mapel=<?php echo $row['kd_mapel'];?>&id_kelas=<?php echo $row['id_kelas'];?>" style="text-decoration:underline" title="Pilih Mata Pelajaran"><?php echo $row['nama_pelajaran'];?></a></td>
