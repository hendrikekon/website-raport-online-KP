...
<tr>
    ...
    $view=mysql_query("select id_kls_siswa, nama, nama_kelas, id_th_ajaran from kelas_siswa, Siswa, kelas where kelas_siswa.id_siswa=siswa.id_siswa and kelas_siswa.id_kelas=kelas.id_kelas");
