...
if(isset($_POST['submit'])){
	...
	for ($i=1; $i<=$jumSis; $i++)
	{
	   ...
	   $query = "insert into ulangan values('','$id_siswa','$id_guru','$kd_mapel','$id_kelas','$nilai')";
	...
	if($hasil){
		...
		?><script language="javascript">document.location.href="?page=guru_input_nilai_ulangan_selesai&status=2";</script><?php
	}
...
<tr>
    ...
    <div id="content-table-inner">
      ...
      <br />
        ...
        <form id="mainform" action="home.php?page=guru_input_nilai_ulangan" method="post">
